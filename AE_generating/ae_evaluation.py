...
out_net.load_state_dict(torch.load(args.state_path + args.net +
                                    '/out-0-vgg16-120-17.pth'))
                                    #'/Sunday_11_September_2022_15h_46m_33s/resnet18-130-regular.pth'))
...
in_net.load_state_dict(torch.load(args.state_path + args.net +
                                   '/in-0-vgg16-120-17.pth'))
                                    #'/Sunday_11_September_2022_16h_10m_46s/resnet18-130-regular.pth'))
